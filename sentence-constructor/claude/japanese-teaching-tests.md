...
<test-cases>
    ...
    <case id="simple-2">
        ...
        <vocabulary>
            <word>
                <japanese>ホン</japanese>
                <romaji>hon</romaji>
                <english>book</english>
            </word>
            <word>
                <japanese>アカイ</japanese>
                <romaji>akai</romaji>
                <english>red</english>
            </word>
        </vocabulary>
...
<test-cases>
    <case id="compound-1">
        ...
        <vocabulary>
            ...
            <word>
                <japanese>ノム</japanese>
                <romaji>nomu</romaji>
                <english>drink</english>
            </word>
            <word>
                <japanese>ミズ</japanese>
                <romaji>mizu</romaji>
...
<vocabulary-test>
    <pair>
        <transitive>
            <japanese>アケル</japanese>
            <romaji>akeru</romaji>
            <english>to open (something)</english>
        </transitive>
        <intransitive>
            <japanese>アク</japanese>
            <romaji>aku</romaji>
...
<teaching-test>
    <scenario id="particle-mistake">
        <student-attempt>ワタシ ガ ガッコー ニ イキマス </student-attempt>
        <error>Incorrect use of ガ particle for regular actions</error>
        <expected-guidance>
            - Acknowledge attempt
            - Explain ハ vs ガ without giving answer
            - Encourage new attempt
        </expected-guidance>
    </scenario>
    <scenario id="conjugation-mistake">
        <student-attempt>ワタシ ワ タベリマシタ</student-attempt>
        <error>Incorrect ル verb conjugation</error>
        <expected-guidance>
            - Point out verb type (ル verb)
