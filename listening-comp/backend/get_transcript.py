...
class YouTubeTranscriptDownloader:
    ...
    def get_transcript(self, video_id: str) -> Optional[List[Dict]]:
        ...
        if not video_id:
            print(f"Invalid video ID or URL")
            return None
    ...
    def save_transcript(self, transcript: List[Dict], filename: str) -> bool:
        ...
        """
        filename = f"../backend/data/transcripts/{filename}.txt"
        ...
        try:
            ...
            print(f"Error saving transcrip1: {str(e)} from {os.getcwd()}")
            return False
...
def main(video_url, print_transcript=False):  
    ...
    # HEMA downloader.save_transcript(transcript, video_url)
    if transcript:
        # Save transcript
...
if __name__ == "__main__":
    ...
    #video_id = "https://www.youtube.com/watch?v=CQ82yk3BC6c&list=PLkGU7DnOLgRMl-h4NxxrGbK-UdZHIXzKQ"
