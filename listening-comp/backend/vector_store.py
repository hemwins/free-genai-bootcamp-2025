...
if __name__ == "__main__":
    ...
    question_files = [
        ("listening-comp/backend/data/questions/sY7L5cfCWno_section2.txt", 2),
        # listening-comp/backend/data/questions/0e0duD8_LFE_section2.txt
        ("listening-comp/backend/data/questions/sY7L5cfCWno_section3.txt", 3)
    ]
    ...
    print(f"Similar questions: {similar}")
