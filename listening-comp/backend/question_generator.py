...
class QuestionGenerator:
    ...
    def get_feedback(self, question: Dict, selected_answer: int) -> Dict:
        ...
        try:
            ...
            cleaned_response = re.sub(r'^```(?:json)?\s*|\s*```\s*$', '', response.strip())
...
if __name__ == "__main__":
    ...
    similar_question = generator.get_feedback({
        "Introduction": "今日はどのような天気ですか？",
        "Conversation": "今日は晴れです。",
        "Question": "今日はどのような天気ですか？",
        "Options": [
            "晴れ",
            "曇り",
            "雨",
