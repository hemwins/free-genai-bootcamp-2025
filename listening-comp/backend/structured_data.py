...
class TranscriptStructurer:
    def __init__(self, model_id: str = MODEL_ID):
        ...
        self.prompts = {
            ...
            Topic:
            [the topic of the conversation that matches from one of "Daily Conversation", "Shopping", "Restaurant", "Travel", "School/Work", "Other"]
            
            Options:
            [4 options each separated by <option-separator>, only one is correct]
            </question>
    ...
    def load_transcript(self, filename: str) -> Optional[str]:
        ...
        try:
            ...
            print(f"Error loading transcript: {str(e)}from {os.getcwd()}")
            return None

if __name__ == "__main__":
    structurer = TranscriptStructurer()
    transcript = structurer.load_transcript("backend/data/transcripts/0e0duD8_LFE.txt")
    ...
    if transcript:
        ...
        structurer.save_questions(structured_sections, "backend/data/questions/0e0duD8_LFE.txt")